...
"Did the checkout page do better?" sounds like a question. It is really several unstated ones bundled together — better by what measure, compared against what, tested how — and left unstated, each one gets filled in by whatever the agent finds convenient, not necessarily what you actually meant. The answer that comes back will sound just as confident either way, because nothing about an under-specified question produces a hedge in the response to match it.
