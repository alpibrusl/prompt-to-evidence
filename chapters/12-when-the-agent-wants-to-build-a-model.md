...
Somewhere in a conversation about predicting which customers might churn, or what next month's demand will look like, the agent will offer to build a model. This chapter is what to know before saying yes, and it starts with a distinction that matters more than anything about the model itself: what is this model actually going to *do*, once it exists.
